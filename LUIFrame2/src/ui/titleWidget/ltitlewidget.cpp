...
#include "ui/tooltWidget/ltoolwidget.h"
...
void LTitleWidget::initWidget()
{
    ...
    m_pToolWidget = new LToolWidget(m_pwidgetBackground);
    ...
    m_pHToolLayout->addSpacing (10);
    m_pHToolLayout->addWidget (m_pToolWidget);
